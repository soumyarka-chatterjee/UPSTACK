...
public class ConsultationController {
    ...
    /* Returns the list of test requests having status as 'LAB_TEST_COMPLETED'*/
    @GetMapping("/in-queue")
   ...
   /*Returns the list of test requests assigned to current doctor*/
    ...
    /*Assigns a particular test request to the current doctor*/
    @PreAuthorize("hasAnyRole('DOCTOR')")
    ...
    /*Updates the result of the current test request with test doctor comments*/
    @PreAuthorize("hasAnyRole('DOCTOR')")
